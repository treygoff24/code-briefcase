"""
Salsa-memoized query functions for the Code Briefcase daemon.

These functions wrap the Code Briefcase API with automatic caching via SalsaDB.
Results are memoized and automatically invalidated when source files change.
"""

from pathlib import Path

from code_briefcase.salsa import SalsaDB, salsa_query
...
def cached_importers(db: SalsaDB, project: str, module: str, language: str) -> dict:
    ...
    from code_briefcase.api import get_imports, scan_project_files
